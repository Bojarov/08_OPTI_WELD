...
def notebook_00():
    ...
    fit_params_mat = fp.fit_params(ff.f_b_field, x_data, volt_list)

    fit_params_mat_s = fp.fit_params(ff.f_b_field_off, x_data, volt_list)
    ...
    pfp.plot_fit_params_f_step_axis(fit_params_mat_s, freq_list, 2)  # shift
    pfp.plot_diff_f_step_axis(fit_params_mat_s, freq_list, 2)
